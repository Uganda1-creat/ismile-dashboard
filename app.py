...
app.title = "Welcome to ISmile Health Dashboard – Uganda"
...
def description_card():
    ...
    return html.Div(
        id="description-card",
        children=[
            html.H5("ISMILE Health"),
            html.H3("Welcome to ISMILE Digital Health – Uganda"),
            html.Div(
                id="intro",
                children="Track patient visits, improve care coordination, and empower communities in Uganda.",
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div(
            id="banner",
            className="banner",
            children=[html.Img(src=app.get_asset_url("I SMILE.png"), style={"height": "50px", "margin": "10px"})
],
        ),
        # Left column
        html.Div(
